...
public final class NewGame extends JPanel {
    ...
    public NewGame(Frame parent, int level) {
        myLevel = level;
        myParent = parent;
        myGameFrame = new JFrame("Rapid Typer");
    ...
    public void initGame() {
        ...
        myGameFrame.setBackground(Color.green);
    ...
    public void updateTimeObject() {
        ...
        while (it.hasNext()) {
            Game game = it.next();
            game.ypos++;
            if (game.ypos > NewGame.HEIGHT) {
                it.remove();
                //  decrease life
                life--;
                playSound("dmusic.wav");
            }
        }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (gameRunning) {
            ...
            while (it.hasNext()) {
                ...
                Font font = new Font("Arial", Font.BOLD + Font.PLAIN, 30);//Segoe Print
                g.setFont(font);
